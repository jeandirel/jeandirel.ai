      ...
      <div className="relative max-w-7xl mx-auto w-full px-6 lg:px-10 grid lg:grid-cols-12 gap-10 items-center">
        <div className="lg:col-span-8">
          ...
          <motion.h1
            ...
            className="font-display text-4xl sm:text-5xl lg:text-7xl text-white leading-[1.05] tracking-tighter mb-6"
          ...
          >
            ...
            <br />
            <span className="text-[#9CA3AF]">{t.hero.title3}</span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-base lg:text-lg text-[#D1D5DB] max-w-2xl leading-relaxed mb-10"
      ...
      <div className="relative max-w-7xl mx-auto w-full px-6 lg:px-10 mt-16 lg:mt-24">
        <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-white/10">
          {[
            ...
            { v: t.hero.stat4, l: t.hero.stat4Label },
          ].map((s, i) => (
            <div
              key={i}
