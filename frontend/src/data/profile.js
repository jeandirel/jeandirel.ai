...
export const PROJECTS = [
  ...
  },
  {
    ...
    summary: {
      en: "Benchmarking and fine-tuning of open-source LLMs (GPT-3, Mistral 7B, Llama 2) to improve customer guidance across home, auto, health and life insurance. Deployed via a Flask interface.",
  ...
  },
  {
    ...
    summary: {
      en: "Designed IoT and ML systems for dairy production at Substrate AI (listed Spanish AI company). Sensor pipelines, animal health predictive models, real-time Grafana dashboards.",
...
export const EXPERIENCES = [
  ...
  },
  {
    ...
    type: "Internship",
    description: {
      en: "Built customer segmentation models and AI-driven funnels (code and no-code), real-time campaign optimization and A/B experimentation with full GDPR compliance.",
      fr: "Modèles de segmentation client et funnels IA (code et no-code), optimisation de campagnes en temps réel, A/B testing, conformité RGPD complète.",
    },
  ...
  },
  {
    ...
    type: "Internship",
    description: {
      en: "Built IoT and AI systems for smart dairy farming at Substrate AI (Spanish listed AI company). Sensor data pipelines, predictive animal health models, Grafana dashboards. End-to-end industrial data science.",
      fr: "Systèmes IoT et IA pour élevage laitier intelligent chez Substrate AI (société espagnole cotée). Pipelines capteurs, modèles prédictifs de santé animale, dashboards Grafana. Data science industrielle end-to-end.",
    },
...
export const SERVICES = [
  ...
  },
  {
    ...
    description: {
      en: "Hands-on advisory for CTOs and AI leaders. Opportunity mapping, architecture review, ethical and GDPR compliance, roadmap and team enablement.",
      fr: "Conseil hands-on pour CTO et responsables IA. Cartographie des opportunités, revue d'architecture, conformité éthique et RGPD, roadmap et montée en compétence des équipes.",
    },
