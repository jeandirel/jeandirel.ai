...
module.exports = async function handler(req, res) {
  ...
  const { name, email, company, subject, message, inquiry_type } = req.body || {};
  ...
  const html = `
    <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#0B0F19;color:#fff;padding:32px;border-radius:8px;">
      <div style="color:#00D4FF;font-family:monospace;font-size:11px;text-transform:uppercase;letter-spacing:3px;margin-bottom:24px;">
        jeandirel.ai — New contact message
      </div>
      ...
      <table style="width:100%;border-collapse:collapse;">
        ...
        <tr><td style="padding:8px 0;color:#9CA3AF;font-size:13px;">Name</td><td style="padding:8px 0;color:#fff;font-size:13px;">${name}</td></tr>
        ...
        ${company ? `<tr><td style="padding:8px 0;color:#9CA3AF;font-size:13px;">Company</td><td style="padding:8px 0;color:#fff;font-size:13px;">${company}</td></tr>` : ""}
        ${subject ? `<tr><td style="padding:8px 0;color:#9CA3AF;font-size:13px;">Subject</td><td style="padding:8px 0;color:#fff;font-size:13px;">${subject}</td></tr>` : ""}
      </table>
