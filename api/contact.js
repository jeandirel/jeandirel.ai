...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const safeSubject = subject ? String(subject).replace(/</g, "&lt;").replace(/>/g, "&gt;") : "";
    ...
    const html = `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#0B0F19;color:#fff;padding:32px;border-radius:8px;">
        ...
        <h2 style="margin:0 0 24px;font-size:20px;">Message de ${safeName}</h2>
        <table style="width:100%;border-collapse:collapse;">
          ...
          <tr><td style="padding:8px 0;color:#9CA3AF;font-size:13px;">Nom</td><td style="padding:8px 0;color:#fff;font-size:13px;">${safeName}</td></tr>
          ...
          ${safeCompany ? `<tr><td style="padding:8px 0;color:#9CA3AF;font-size:13px;">Société</td><td style="padding:8px 0;color:#fff;font-size:13px;">${safeCompany}</td></tr>` : ""}
          ${safeSubject ? `<tr><td style="padding:8px 0;color:#9CA3AF;font-size:13px;">Sujet</td><td style="padding:8px 0;color:#fff;font-size:13px;">${safeSubject}</td></tr>` : ""}
        </table>
