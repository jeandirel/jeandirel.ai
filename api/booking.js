...
module.exports = async function handler(req, res) {
  ...
  const html = `
    <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#0B0F19;color:#fff;padding:32px;border-radius:8px;">
      ...
      <h2 style="margin:0 0 24px;font-size:20px;">Demande de réunion de ${name}</h2>
      <table style="width:100%;border-collapse:collapse;">
        <tr><td style="padding:8px 0;color:#9CA3AF;font-size:13px;width:140px;">Nom</td><td style="padding:8px 0;color:#fff;font-size:13px;">${name}</td></tr>
        ...
        ${company ? `<tr><td style="padding:8px 0;color:#9CA3AF;font-size:13px;">Société / Labo</td><td style="padding:8px 0;color:#fff;font-size:13px;">${company}</td></tr>` : ""}
        <tr><td style="padding:8px 0;color:#9CA3AF;font-size:13px;">Objet</td><td style="padding:8px 0;color:#fff;font-size:13px;">${purpose}</td></tr>
        ${preferred_date ? `<tr><td style="padding:8px 0;color:#9CA3AF;font-size:13px;">Date souhaitée</td><td style="padding:8px 0;color:#fff;font-size:13px;">${preferred_date}</td></tr>` : ""}
      </table>
      ${notes ? `
